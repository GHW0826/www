...
public:
	...
	// default timer 사용
	virtual bool CheckTimerImpl() { return false; } 
	//타이머 생성
	virtual long AddTimer(unsigned int TimerID, unsigned int StartTime, unsigned int Period) { return false; }
...
// NetworkEngine * CreateNetworkEngine(bool Server, IEngine * pEngine) : 함수의 선언
#ifdef __linux__
